            ...
            <section class="listings">
                ...
                <div class="box-container">
                    ...
                    <div class="box">
                        ...
                        <h3 class="name">modern flats and appartments</h3>
                        <p class="location"><i class="fas fa-map-marker-alt"></i><span>Banglore, India</span></p>
                        <div class="flex">
                            <p><i class="fas fa-bed"></i><span>4</span></p>
                            <p><i class="fas fa-bath"></i><span>3</span></p>
                    ...
                    <div class="box">
                        ...
                        <h3 class="name">Modern Flats and Appartments</h3>
                        <p class="location"><i class="fas fa-map-marker-alt"></i><span>Haldwani, India - 263139</span></p>
                        <div class="flex">
                            <p><i class="fas fa-bed"></i><span>4</span></p>
                            <p><i class="fas fa-bath"></i><span>4</span></p>
                            <p><i class="fas fa-maximize"></i><span>1400sqft</span></p>
                        </div>
                        <Link to="/view_property6" class="btn">View Property</Link>
                    </div>
