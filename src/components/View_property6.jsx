...
import house7 from "./images/house-img-7.webp";
const View_property6 = () => {
        ...
        <>
            ...
            <section className="view-property">
                ...
                <div className="details">
                    ...
                    <div class="info">
                        <p><i class="fas fa-tag"></i><span>31 lac</span></p>
                        <p><i class="fas fa-user"></i><span>Chirag (owner)</span></p>
                        ...
                        <p><i class="fas fa-calendar"></i><span>23-08-2023</span></p>
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="box">
                            <p><i>Carpet area :</i><span>1400 sqft</span></p>
                            <p><i>Age :</i><span>2 years</span></p>
                            <p><i>Room floor :</i><span>4</span></p>
                            <p><i>Total floors :</i><span>23</span></p>
